...
exports.default = applicationHistory;
...
const LoginPage_1 = __webpack_require__(/*! ./LoginPage/LoginPage */ "./src/components/LoginPage/LoginPage.tsx");
const react_router_dom_1 = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
const History_1 = __webpack_require__(/*! ../History */ "./src/History.ts");
const PrivateRoute_1 = __webpack_require__(/*! ./Utilities/PrivateRoute */ "./src/components/Utilities/PrivateRoute.tsx");
const Dashboard_1 = __webpack_require__(/*! ./Dashboard/Dashboard */ "./src/components/Dashboard/Dashboard.tsx");
exports.App = () => (React.createElement(react_router_1.Router, { history: History_1.default.history },
    React.createElement("div", { className: "app" },
        React.createElement("div", { className: "navigation" },
            React.createElement(react_router_dom_1.Link, { to: '/login' }, "Login")),
        React.createElement(react_router_1.Switch, null,
            React.createElement(react_router_1.Route, { path: "/login", exact: true, component: LoginPage_1.default }),
            React.createElement(PrivateRoute_1.default, { path: "/", exact: true, component: Dashboard_1.default })))));
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const Dashboard = () => (React.createElement("div", { className: "dashboard" }, "Dashboard"));
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const Authentication_1 = __webpack_require__(/*! ../../stores/Authentication */ "./src/stores/Authentication.ts");
const History_1 = __webpack_require__(/*! ../../History */ "./src/History.ts");
class LoginPage extends React.Component {
    constructor(props) {
        super(props);
        this.onSubmit = (event) => {
            Authentication_1.default.authenticate(this.state.password)
                .then(() => {
                History_1.default.history.replace('/');
            })
                .catch(() => {
                this.setState({
                    loginFailed: true,
    ...
    render() {
        return (React.createElement("div", { className: "login page" },
            React.createElement("form", { onSubmit: this.onSubmit },
                ...
                React.createElement("input", { name: "password", type: "password", id: "password", onChange: this.onChange }),
                React.createElement("input", { type: "submit", value: "Login" })),
            this.state.loginFailed && (React.createElement("div", { className: "error" }, "Password was incorrect, please try again."))));
    }
}
...
/***/ "./src/components/Utilities/PrivateRoute.tsx":
/*!***************************************************!*\
  !*** ./src/components/Utilities/PrivateRoute.tsx ***!
  \***************************************************/
/*! no static exports found */
...
const PrivateRoute = (props) => {
    return Authentication_1.default.isAuthenticated ? (React.createElement(react_router_dom_1.Route, Object.assign({}, props))) : (React.createElement(react_router_dom_1.Redirect, { to: "login" }));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const Cookies = __webpack_require__(/*! es-cookie */ "./node_modules/es-cookie/src/es-cookie.js");
